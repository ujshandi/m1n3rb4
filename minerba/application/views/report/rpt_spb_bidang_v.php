...
//        $("#filter_alamat").val('');
    ...
    getUrl<?=$objectId;?> = function (tipe){
        ...
        if (tipe==1){
                return "<?=base_url()?>report/rpt_spb_bidang/grid/"+filawal+"/"+filakhir+"/"+filbidang+"/"+filkategori+"/"+tipe_periode;
        }
        else if (tipe==2){
                return "<?=base_url()?>report/rpt_spb_bidang/pdf/"+filawal+"/"+filakhir+"/"+filbidang+"/"+filkategori+"/"+tipe_periode;
        }else if (tipe==3){
                return "<?=base_url()?>report/rpt_spb_bidang/excel/"+filawal+"/"+filakhir+"/"+filbidang+"/"+filkategori+"/"+tipe_periode;
        }
