...
//        $("#filter_alamat").val('');
	...
	<table id="dg<?=$objectId;?>" style="height:auto;width:auto" title="Data SPB" toolbar="#tb<?=$objectId;?>" fitColumns="false" singleSelect="true" rownumbers="true" pagination="true">
	  <thead>
	  <tr>
