...
$(function(){
   ...
   importData<?=$objectId;?>=function(){
    ...
    newData<?=$objectId;?> = function (){  
        $('#dlg<?=$objectId;?>').dialog('open').dialog('setTitle','Add Kegiatan');  
	...
	<div id="dlg<?=$objectId;?>" class="easyui-dialog" style="width:750px;height:300px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
	  ...
	  <form id="fm<?=$objectId;?>" method="post">
		 <div class="fitem">
		  ...
		  <input name="tahun" class="easyui-numberbox" size="3" required="true">		  
		</div>
         <div class="fitem">
		  <label style="width:100px;vertical-align:top">Kode Kegiatan :</label>
		  <input name="kode" class="easyui-validatebox" size="10" required="true">
		...
		<div class="fitem">
		  ...
		  <input name="pagu" class="easyui-numberbox" data-options="precision:2,groupSeparator:'.',decimalSeparator:','" size="15" required="true">		  
		</div>
...
<!-- Form Import -->
	<div id="dlgimport<?=$objectId;?>" class="easyui-dialog" style="width:500px;height:200px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
		<div class="ftitle">Import Data Kegiatan dari Excel</div>
		<?php 
