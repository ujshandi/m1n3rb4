...
left join v_spb_draft d on b.bidang_id = d.bidang_id '.($filtanggal<>''?' and d.'.$filtanggal:'').'
left join v_spb_verifikasi v on b.bidang_id = v.bidang_id '.($filtanggal<>''?' and v.'.$filtanggal:'').'
left join v_spb_penguji p on b.bidang_id = p.bidang_id '.($filtanggal<>''?' and p.'.$filtanggal:'').'
left join v_spb_spm s on b.bidang_id = s.bidang_id '.($filtanggal<>''?' and s.'.$filtanggal:'').'
left join v_spb_bendahara h on b.bidang_id = h.bidang_id '.($filtanggal<>''?' and h.'.$filtanggal:''),false);
