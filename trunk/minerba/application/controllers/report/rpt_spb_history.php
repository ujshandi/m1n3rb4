...
class Rpt_spb_history extends CI_Controller {
    ...
    function __construct()
    {
        ...
        $this->load->model('/report/rpt_spb_history_model');
    ...
    function index(){
        ...
        $this->load->view('report/rpt_spb_history_v',$data);
    }
	...
	$periodeakhir = $this->utility->ourDeFormatSQLDate($periodeakhir);
        echo $this->rpt_spb_history_model->easyGrid(1,$tipeapproval,$periodeawal,$periodeakhir,$bidang,$kategori,$nomor);
    }
